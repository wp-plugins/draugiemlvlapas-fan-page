	...
	w:function(par){
		...
		if (par['fans'].length){
			...
			for (i=0;i<par['fans'].length;i++){
				html += '<div class="fancontainer"><a class="pbg" href="http://mediabox.lv/a/fryped.php?gotou=http://draugiem.lv'+par['fans'][i]['url']+'"><div style="background-image: url('+par['fans'][i]['image']+')"></div></a><a class="name" href="http://mediabox.lv/a/fryped.php?gotou=http://draugiem.lv'+par['fans'][i]['url']+'">'+par['fans'][i]['name']+'</a></div><?php  //fancontainer ?>';
			}
