 ...
 * Plugin URI: http://darbi.mediabox.lv/20-draugiem-lvlapas-fanu-wordpress-spraudnis/
...
D = {
	w:function(par){
		...
		if (par['fans'].length){
			...
			html += '<div class="dfoot"><a href="http://darbi.mediabox.lv/tag/wordpress-spraudnu-izstrade/?utm_campaign=WordPress_Plugins&utm_content=<?php echo FRYPEFANPAGEF.'-v'.VERSION;?>" title="WordPress spraudņu un tēmu izstrāde"><img src="<?php echo WP_PLUGIN_URL.'/'.FRYPEFANPAGEF.'/img/';?>mediabox-icon-16sq.png" width="16" height="16" alt="mediabox.lv" border="0"></a></div></div><?php  //fanlist ?>';
		}
		html += '</div>';
...
//echo '<p><strong>'.$rss->get_title().'</strong></p>';
if ($maxitems !=0):
...
<?php echo '<div>';
		...
		echo '</div>'; 
		echo '<p><strong>MediaBox.lv</strong> &amp; <strong>SimpleMediaCode.com</strong></p>';
