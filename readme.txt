...
= 0.1.8 =
* +unregister
* x small changes in code (javascript)

= 0.1.7 =
* x small changes in code
* +link fix
* +ieteikt draugiem (Draugiem.lv/say pop-up poga)
...
* x small changes in code / nelieli izmaiņas kodā
...
= 0.1.2 =
* x short code clean-up

= 0.1.1 =
* x Small mistype correction
