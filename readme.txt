...
= 0.2.1 =
* Atbalsta forums
* No javascript ti iframe
* Informācija par  [0.2.1 versiju](http://mediabox.lv/code/Draugiem.lv_Lapas_Fan_page/Latviski#0.2.1)
* Only  (mostly) latvian support only since no international usage
